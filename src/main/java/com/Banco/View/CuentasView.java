...
import com.Banco.Implements.CuentasImplementsDAO;
...
public class CuentasView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setText("Ver saldo Cuentas");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(nombretxt, javax.swing.GroupLayout.PREFERRED_SIZE, 198, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(39, 39, 39)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jLabel2)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(saldotxt, javax.swing.GroupLayout.PREFERRED_SIZE, 186, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        //validaciones
        if(nombre.isEmpty()){
            javax.swing.JOptionPane.showMessageDialog(this, "Debe llenar el nombre al menos \n ", "AVISO", javax.swing.JOptionPane.ERROR_MESSAGE);
            nombretxt.requestFocus();
            return;
        }
        
        float saldos = Float.parseFloat(saldo);
        
        id_cuenta cuentas = new id_cuenta();
        cuentas.setNombreCliente(nombre);
        cuentas.setSaldo(saldos);
        
        try{
            CuentasDAO cuentasDAO = new CuentasImplementsDAO();
            cuentasDAO.registrar(cuentas);
            javax.swing.JOptionPane.showMessageDialog(this, "Registro Realizado con exito \n ", "AVISO", javax.swing.JOptionPane.INFORMATION_MESSAGE);
            nombretxt.setText(" ");
            saldotxt.setText(" ");
        }catch(Exception e){
            javax.swing.JOptionPane.showMessageDialog(this, "Ocurrio un error al registrar usuario \n ", "AVISO", javax.swing.JOptionPane.ERROR_MESSAGE);
